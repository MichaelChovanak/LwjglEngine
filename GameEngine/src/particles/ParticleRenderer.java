...
public class ParticleRenderer {
	...
	private void updateModelViewMatrix(Vector3f position, float rotation, float scale, Matrix4f viewMatrix, float[] vboData) {
		...
		//the top-left 3x3 floats control the rotation of the particle. To have the particle always facing the camera, we need these
		//nine floats to be the identity matrix. We do this by setting the model matrix 9 floats to the transpose of the view matrix,
		//so multiplied, they become the identity for rotation.
